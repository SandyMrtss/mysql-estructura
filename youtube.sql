...
CREATE TABLE IF NOT EXISTS `youtube`.`comments` (
  ...
  `videos_id_video` INT UNSIGNED NOT NULL,
  `users_id_user` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `youtube`.`videos_has_tags` (
  ...
  INDEX `fk_videos_has_tags_tags1_idx` (`tags_id_tag` ASC) ,
  INDEX `fk_videos_has_tags_videos1_idx` (`videos_id_video` ASC) ,
...
CREATE TABLE IF NOT EXISTS `youtube`.`users_subscribe_channels` (
  `channels_id_channel` INT UNSIGNED NOT NULL,
  `users_id_user` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`channels_id_channel`, `users_id_user`),
  INDEX `fk_channels_has_users_users1_idx` (`users_id_user` ASC) ,
  INDEX `fk_channels_has_users_channels1_idx` (`channels_id_channel` ASC) ,
...
CREATE TABLE IF NOT EXISTS `youtube`.`likes_dislikes_video` (
  ...
  INDEX `fk_likes_dislikes_video_videos1_idx` (`videos_id_video` ASC) ,
  INDEX `fk_likes_dislikes_video_users1_idx` (`users_id_user` ASC) ,
...
CREATE TABLE IF NOT EXISTS `youtube`.`users_creates_playlists` (
  ...
  INDEX `fk_users_has_playlists_playlists1_idx` (`playlists_id_playlist` ASC) ,
  INDEX `fk_users_has_playlists_users1_idx` (`users_id_user` ASC) ,
...
CREATE TABLE IF NOT EXISTS `youtube`.`playlists_has_videos` (
  ...
  INDEX `fk_playlists_has_videos_videos1_idx` (`videos_id_video` ASC) ,
  INDEX `fk_playlists_has_videos_playlists1_idx` (`playlists_id_playlist` ASC) ,
...
CREATE TABLE IF NOT EXISTS `youtube`.`users_like_comments` (
  `users_id_user` INT UNSIGNED NOT NULL,
  `comments_id_comment` INT UNSIGNED NOT NULL,
  `type` ENUM('like', 'dislike') NOT NULL DEFAULT 'like',
  `date` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`users_id_user`, `comments_id_comment`),
  INDEX `fk_users_has_comments_comments1_idx` (`comments_id_comment` ASC) ,
  INDEX `fk_users_has_comments_users1_idx` (`users_id_user` ASC) ,
